...
export default function InfoBox({info}){
    ...
    let hotWeather = "https://plus.unsplash.com/premium_photo-1688804790068-4a0978939cd0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGhlYXR8ZW58MHx8MHx8fDA%3D";
    ...
    return(
      ...
      <CardMedia
        ...
        image={
          ...
          coldWeather : info.temp > 40
          ? hotWeather : info.temp > 30 && info.temp < 40
          ? imageUrl : imageUrl
        }
        title="green iguana"
      />
      <CardContent>
        <Typography gutterBottom variant="h5" component="div">
          ...
          <AcUnitIcon></AcUnitIcon> : info.temp > 40
